      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="col-span-1 md:col-span-1 flex flex-col gap-6">
            ...
            >
              <div className="relative flex h-8 w-8 items-center justify-center overflow-hidden shadow-md transition-transform group-hover:scale-105">
                <img
            ...
            <div className="flex gap-4">
              <a href="https://github.com/Masriadi/pdf-kuansing" target="_blank" rel="noopener noreferrer" className="p-2 rounded-full bg-[hsl(var(--color-muted))] text-[hsl(var(--color-muted-foreground))] hover:bg-[hsl(var(--color-primary))] hover:text-white transition-all">
