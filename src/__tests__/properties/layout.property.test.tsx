...
vi.mock('next-intl', () => ({
  useTranslations: () => (key: string) => {
    const translations: Record<string, string> = {
      ...
      'buttons.close': 'Close',
      'footer.copyright': '© {year} PDF Kuansing. Hak cipta dilindungi.',
...
describe('Layout Property Tests', () => {
   ...
   * SHALL contain the brand name "PDF Kuansing" in the header or title area.
   */
  describe('Property 2: Brand Consistency', () => {
    it('Header component displays PDF Kuansing brand name for all locales', () => {
      fc.assert(
        fc.property(
          ...
          (locale) => {
            ...
            expect(brandElement.textContent).toBe('PDF Kuansing');
    ...
    it('Footer component displays PDF Kuansing brand name for all locales', () => {
      fc.assert(
        fc.property(
          fc.constantFrom(...locales),
          (locale) => {
      ...
      fc.assert(
        fc.property(
          ...
          (locale) => {
            ...
            expect(headerBrandText).toBe('PDF Kuansing');
      ...
      fc.assert(
        fc.property(
          ...
          (invalidLocale) => {
            ...
            localStorage.setItem('pdf-kuansing-language-preference', invalidLocale);
